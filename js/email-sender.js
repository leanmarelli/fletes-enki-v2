// js/email-sender.js
const RESEND_API_KEY = 're_HitX65WU_8nT3J82KGPsu6TP5uprcidYN';
...
export async function enviarEmailViaje(viaje, fletero, tipo = 'nuevo') {
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <p style="color: #6c757d; font-size: 14px; text-align: center;">
        ...
        <a href="https://fletes-enki.netlify.app" style="color: #198754;">Ver agenda completa</a>
      </p>
    </div>
  `;
    ...
    try {
        const response = await fetch('https://api.resend.com/emails', {
            ...
            body: JSON.stringify({
                from: 'Fletes Enki <leanmarelli17@gmail.com>',
                to: 'leanmarelli17@gmail.com', // TESTING - cambiar a fletero.mail después
                subject: asunto,
                html: cuerpo,
            })
        });
